...
export class FrameHelper implements WalleSpec.FrameHelper {
  ...
  static readonly SERVICE_TYPE_AUDIO = new Enum(10002, 'SERVICE_TYPE_AUDIO', '音频流')
  static readonly SERVICE_TYPE_VIDEO = new Enum(10003, 'SERVICE_TYPE_VIDEO', '视频流')
  ...
  readonly getMeta = async () => {
    ...
    const typeNumber = view.getUint32(0)
